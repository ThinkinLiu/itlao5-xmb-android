...
public class NearByUserFragment extends FollowedUserFragment implements View.OnClickListener{
    ...
    private void initTitleView(View rootView) {
        ...
        View saveBtn = rootView.findViewById(ResFinder.getId("umeng_comm_title_setting_btn"));
        saveBtn.setVisibility(View.GONE);
        rootView.findViewById(ResFinder.getId("umeng_comm_title_back_btn")).setOnClickListener(this);
